        ...
        <footer className="container-fluid">
          <div className="row">
            <div className="col-xs-12">              
              ...
              <div className="disclaimer">This site was built with <a className="link" target="_blank" href="https://facebook.github.io/react/index.html" rel="nofollow">React.js</a>, <a className="link" target="_blank" href="http://getbootstrap.com/" rel="nofollow">Bootstrap</a>, and Facebook&#39;s <a className="link" target="_blank" href="https://facebook.github.io/flux/" rel="nofollow">Flux</a> architecture. The data used to populate the widgets on this site comes from a painstakingly created 80,000+ line JSON file.</div>              
            </div>
          </div>
        </footer>        
      </div>
