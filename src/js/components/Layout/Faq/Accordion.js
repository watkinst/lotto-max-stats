...
export default class Accordion extends React.Component {
  ...
  populatePanels() {
    ...
    var answers = [
      "Lotto Max is a Canadian Lottery with a minimum jackpot of ten million dollars and maximum jackpot of fifty million dollars. Additional prizes of one million dollars each (called Max Millions) are added when the jackpot reaches the maximum. Draws are held every Friday night at 11:29:59PM Atlantic Time.",
